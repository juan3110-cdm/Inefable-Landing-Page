...
export const translations: Record<Lang, Translations> = {
  es: {
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          price: '200€',
          period: '/mes',
          note: '+ 250€ de configuración inicial (pago único)',
    ...
    contact: {
      ...
      serverError: 'Algo falló por nuestra parte — inténtalo de nuevo o escríbenos directamente a inefableia.help@gmail.com.',
    ...
    chat: {
      ...
      errorMessage: 'Ha habido un error. Inténtalo de nuevo o escríbenos a inefableia.help@gmail.com.',
    },
  },
  ...
  en: {
    ...
    contact: {
      ...
      serverError: 'Something went wrong on our end — please try again, or email us directly at inefableia.help@gmail.com.',
    ...
    chat: {
      ...
      errorMessage: 'Something went wrong. Please try again or email us at inefableia.help@gmail.com.',
    },
  },
}
